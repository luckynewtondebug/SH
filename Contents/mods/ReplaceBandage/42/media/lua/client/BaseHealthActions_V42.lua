...
-- Copied Class from ISHealthPanel.lua because it's fucking private. --
...
return
{
    HCleanBurn = HCleanBurn,
    HDisinfect = HDisinfect,
    HApplyGarlic = HApplyGarlic,
    HApplyPlantain = HApplyPlantain,
    HApplyBandage = HApplyBandage,
    HApplyPoultice = HApplyPoultice,
    HApplyComfrey = HApplyComfrey,
    HRemoveBullet = HRemoveBullet,
    HRemoveGlass = HRemoveGlass,
    HRemoveSplint = HRemoveSplint,
    HRemoveBandage = HRemoveBandage,
    HRemoveStitch = HRemoveStitch,
    HSplint = HSplint,
    HStitch = HStitch,
}